...
class Evaluator:
    ...
    def run(self, opt):
        ...
        seq_paths, save_dir, MOT_results_folder, gt_folder = e.eval_setup(
            opt, val_tools_path)
        # print seq_paths, save_dir, MOT_results_folder, gt_folder
        print('seq_paths', seq_paths, 'save_dir',
              save_dir, MOT_results_folder, gt_folder)

        free_devices = ['0']  # e.device_setup(opt, seq_paths)
...
def parse_opt():
    ...
    parser.add_argument('--project', default=EXAMPLES /
                        'runs' / 'val', help='save results to project/name')
    parser.add_argument('--exist-ok', action='store_true',
                        help='existing project/name ok, do not increment')
    parser.add_argument('--benchmark', type=str,
                        default='MOT17-mini', help='MOT16, MOT17, MOT20')
